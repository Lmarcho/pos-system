        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand d-flex" href="{{ url('/home') }}">
                    ...
                    <div class="pl-2 pt-2">CarLovers</div>
                </a>
                <a class="navbar-brand " href="{{ url('/sales') }}">
                    <div class="pl-5 pt-2">Sales</div>
                </a>
                <a class="navbar-brand " href="{{ url('/stock') }}">
                    <div class="pl-5 pt-2">Stock</div>
                </a>

                <a class="navbar-brand " href="{{ url('/customer') }}">
                    <div class="pl-5 pt-2">Customer management</div>
                </a>
                <a class="navbar-brand " href="#">
                    <div class="pl-5 pt-2 dropdown-toggle" data-toggle="dropdown ">Report</div>
